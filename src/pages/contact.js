    ...
    <Container fluid="md" className="layout-center">
      <Row xs={1} md={3}>
        <Col className="pb-2">
          <div className="card contact-card">
            <div className="card-image-top contact-img mx-auto mt-5">
              <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-geo-alt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <Col className="pb-2">
          <div className="card contact-card">
            <div className="card-image-top contact-img mx-auto mt-5">
                <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-telephone-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
